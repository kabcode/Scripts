...
ROBOCOPY %NASSMARTPREVIEWS% %PCSMARTPREVIEWS% /NFL /NDL /XJ /Z /S /FFT /R:1 /W:10 /XA:H

@rem copy existing previews
ROBOCOPY %NASPREVIEWS% %PCPREVIEWS% /NFL /NDL /XJ /Z /S /FFT /R:1 /W:10 /XA:H
...
@rem copy existing smart previews
ROBOCOPY %PCSMARTPREVIEWS% %NASSMARTPREVIEWS% /NFL /NDL /XJ /Z /S /FFT /R:1 /W:10 /XA:H

@rem copy existing previews
ROBOCOPY %PCPREVIEWS% %NASPREVIEWS% /NFL /NDL /XJ /Z /S /FFT /R:1 /W:10 /XA:H
